...
int pir,flag =0;
  ...
  while (1)
  {
	  pir = HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_6);
	  if(DHT11_Start())
	      {
	  ...
	  sprintf (buffer, "%d", pir);
	  	  	        	  HD44780_SetCursor(0,0);
	  	  	        	  HD44780_PrintStr(buffer);
	 /* if(pir==1)
	  {
	  HD44780_SetCursor(0,0);
	   HD44780_PrintStr("PIR WORKING");
	  }
	  if(pir==0)
	  {
		  HD44780_SetCursor(0,0);
		  	   HD44780_PrintStr("PIR notWORKING");
	  }
	    */  HAL_Delay(1000);
